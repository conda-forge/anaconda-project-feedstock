About anaconda-project-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/anaconda-project-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/anaconda-project-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/anaconda-project-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `anaconda-project` can be installed with `conda`:
...
```
mamba install anaconda-project
```

It is possible to list all of the versions of `anaconda-project` available on your platform with `conda`:
...
```
mamba search anaconda-project --channel conda-forge
```
...
mamba repoquery search anaconda-project --channel conda-forge

# List packages depending on `anaconda-project`:
mamba repoquery whoneeds anaconda-project --channel conda-forge

# List dependencies of `anaconda-project`:
mamba repoquery depends anaconda-project --channel conda-forge
```
